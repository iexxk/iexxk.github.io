...
updated: 2021-03-18 18:28:57
categories: 算法
tags: [快速排序,线性时间选择,流水作业调度,0-1背包问题,贪心算法,二分搜索,矩阵连乘,最优二叉搜索树,分治法,动态规划,合并排序,哈弗曼编码]
---
## 快速排序
![Sorting_quicksort_anim](https://s3.ax1x.com/2021/03/18/62TEtS.gif)
### 思想
...
![timeselect](https://s3.ax1x.com/2021/03/18/62TFTf.jpg)
...
## 0-1背包问题
![250px-Knapsack.svg](https://s3.ax1x.com/2021/03/18/62Ti0P.png)
### 问题描述
...
## 贪心算法
![Greedy_algorithm_36_cents.svg](https://s3.ax1x.com/2021/03/18/62TAk8.png)
### 思想
...
4. 把子问题的解局部最优解合成原来解问题的一个解。
    eg： 0-1背包问题、哈弗曼编码
## 二分搜索
![Binary_search_into_array](https://s3.ax1x.com/2021/03/18/62TPmt.png)
时间复杂度	$O(log(n))$
最优时间复杂度	$O(1)$
平均时间复杂度	$O(log(n))$
...
## 矩阵连乘
![jx](https://s3.ax1x.com/2021/03/18/62TVfg.gif)
###### 问题描述
...
eg: 背包问题
## 合并排序（归并排序）
![Merge-sort-example-300px](https://s3.ax1x.com/2021/03/18/62TepQ.gif)
时间复杂度	$O(nlog(n))$
最优时间复杂度	$O(n)$
平均时间复杂度	$O(nlog(n))$
...
# 哈弗曼编码
![350px-Huffman_tree_2.svg](https://s3.ax1x.com/2021/03/18/62Tmlj.png)
这个句子“this is an example of a huffman tree”中得到的字母频率来建构霍夫曼树。句中字母的编码和频率如图所示。编码此句子需要135 bit（不包括保存树所用的空间）

![Huffman_algorithm](https://s3.ax1x.com/2021/03/18/62Tn6s.gif)